...
import { Server, Cloud, Cpu, ArrowRight, Pencil, ChevronDown, ChevronUp, CheckCircle2, Loader2, Plus, Settings2, Zap, Globe, GitBranch, Search, ShieldAlert, ShieldCheck, Boxes, RotateCcw } from "lucide-react";
import {
  RESOURCE_TIER_ORDER,
  RESOURCE_TIER_SPECS,
  formatCpuCores,
